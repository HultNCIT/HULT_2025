  ...
  return (
    <div className="min-h-screen font-poppins ">
      ...
      <div className="flex flex-col md:flex-row mt-32 px-6 md:px-20">
        ...
        <div className="w-full md:w-2/3 flex flex-col justify-center pl-0 md:pl-12 py-4">
          {/* ABOUT US Badge */}
          <div className="my-4">
            <Pill_outline
              className="text-sm"
          ...
          <div className="main-heading my-4">
            <h4 className=" font-bold mb-4">HULT PRIZE EVENT</h4>
            {/* Description */}
            <p className="text-gray-600 leading-relaxed">
              In slightly more than ten years, the foundation has invested over
              $100 million in the impact sector, which it played a crucial role
              in establishing. With a presence on over 1500 college and
              university campuses across 121 countries, and boasting a global
              team exceeding 30,000 members, including staff, student
              volunteers, and change-makers, the Hult Prize remains a
              transformative global leader in 21st-century education, soft
              skills training, and entrepreneurial development.
            </p>
          </div>
          {/* Subheading */}
          <div class="sub-heading my-4">
            <h4 className="font-bold mb-4">OnCampus Event</h4>
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              success of the OnCampus Program. Campus Directors organize various
              events, and winning teams, carefully selected by our esteemed
              judging panel, move forward to the next stage.
            </p>
          </div>
        </div>
      </div>
      <div className="flex flex-col md:flex-row px-6 md:px-20">
        ...
        <div className="w-full md:w-2/3 flex flex-col justify-center pl-0 md:pl-12">
          {/* Main Heading */}
          <div className="about-content my-4">
            <h4 className=" font-bold mb-4">Regional Summit</h4>
            {/* Description */}
            <p className="text-gray-600 leading-relaxed">
          ...
          {/* Subheading */}
          <div className="about-content my-4">
            <h4 className="font-bold mb-4">Global Accelerator</h4>
            {/* Additional Description */}
            <p className="text-gray-600 leading-relaxed">
              Global Accelerator (July - August): Twelve semi-finalist teams, ,
              refine their pitches with mentors. The journey continues as they
              travel to London for an intensive two-week program, and six
              standout teams are chosen for the prestigious Global Finals.
            </p>
          </div>
          <div className="about-content my-4">
            <h4 className=" font-bold mb-4">Global Finals</h4>
            {/* Additional Description */}
            <p className="text-gray-600 leading-relaxed">
