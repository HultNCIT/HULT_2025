...
const Footer=()=> {
  return (
    <div className='h-[300px]'>
        <div className="bg-[#231f20] text-white h-full w-full flex flex-col md:flex-row flex-wrap justify-between items-center tracking-wider poppins-extralight text-lg px-6 md:px-28 py-7  ">
          <div>
            <Image
